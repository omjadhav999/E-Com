        ...
        <footer className="border-t py-12">
            ...
            <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6 flex flex-col items-center justify-center text-center space-y-4">
                <div className="flex space-x-4">
                   <a href="https://github.com/omjadhav999" target="_blank" rel="noreferrer">
                       <GitHubIcon />
                   </a>
                   <a href="https://www.linkedin.com/in/om-jadhav-463b96259/" target="_blank" rel="noreferrer">
                       <LinkedInIcon />
                   </a>
                </div>
            <p className="text-gray-500 text-sm tracking-tighter">
                Made by Om Jadhav with ❤️
            </p>
        </div>
        </footer>
    )
