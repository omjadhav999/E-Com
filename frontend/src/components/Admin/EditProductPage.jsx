...
const EditProductPage = () => {
    const [productData, setProductData] = useState({
        ...
        images: [
            {
                url: "https://picsum.photos/500?random=56"
            },
            {
                url: "https://picsum.photos/500?random=59"
            }
        ],
    });
        ...
        <div className="max-w-5xl mx-auto p-6 shadow-md rounded-md">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <input type="number" name="sku" value={productData.sku} onChange={handleChange} className="w-full border border-gray-300 rounded-md p-2"/>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <label className="inline-block bg-blue-600 text-white px-4 py-2 rounded-md cursor-pointer hover:bg-blue-700 transition">
                    Choose File
                ...
                <button type="submit" className="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition-colors" >Update</button>
            </form>
        </div>
    )
};
