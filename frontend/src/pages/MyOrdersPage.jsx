                    ...
                    <tbody>
                        {orders.length > 0 ? orders.map((order) => (
                            <tr key={order._id} onClick={() => handleRowClick(order._id)} className='border-b hover:border-gray-50 cursor-pointer'>
                                ...
                                <td className='py-2 px-2 sm:py-4 sm:px-4'>
                                    <span className={`${order.isPaid ? "bg-green-100 text-green-700" : "bg-red text-red-700"} px-2 py-1 rounded-full text-xs sm:text-sm font-medium`}>{order.isPaid ? "Paid" : "Pending"}</span>
                                </td>
                            </tr>
                        ))
                    : (
